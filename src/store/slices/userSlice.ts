...
import { IUserInitialState } from "../../types/productTypes";
...
export const fetchGetMe = createAsyncThunk("user/fetchGetMe", async function (_, { dispatch }) {
  ...
  if (token !== "undefined") {
    ...
    if (data) {
      ...
      if (refresh_token !== "undefined") {
        const newToken: Response = await httpRequest(`${PATHDOMAIN}/admin/refreshToken`, "POST", {
          refresh_token,
        });
